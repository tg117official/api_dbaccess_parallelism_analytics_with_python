...
# What is Pickle?
# Pickle is a Python module used for **serializing** and **deserializing** Python objects, meaning it
# converts objects into a byte stream (serialization) for storage or transmission and reconstructs them back
# into Python objects (deserialization).
#
# ---
#
# Purpose:
